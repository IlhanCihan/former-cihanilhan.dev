				...
				<Row>
					<Col sm={9}>
						<h1 style={{marginTop: '15px'}}>
							...
							<img style={{marginLeft: '10px'}} width="50" height="50" src="https://camo.githubusercontent.com/66e00b1e8f7047726770f791fdd5deac5341bf0b598f6d0202cbc94cda80fb06/68747470733a2f2f692e696d6775722e636f6d2f6c73697a67476c2e676966" alt=''/>
						</h1>
					</Col>
					<Col sm={3}>
					...
					<>
						...
						<div>
							...
							<h4 style={{
								marginLeft: '15px',
								marginTop : '10px'
							}}>I like to make stuff and post it on internet 🌱</h4>
						</div>
						<br/><br/><br/>
						<Row>
							<Col>
								...
								<div>
									...
									<Card.Title style={{
										marginLeft: '15px',
										marginTop : '10px'
									}} className="font-weight-bold mb-1">Bachelor of Science in Computer Science for economics</Card.Title>
										...
										<Col md={5}>
											<div>
												<h5 style={{
													...
													marginTop : '10px',
													fontWeight: 'bold'
												}} className="font-weight-bold mb-1">Turkish: </h5>
											...
											<div>
												<h5 style={{
													...
													marginTop : '10px',
													fontWeight: 'bold'
												}} className="font-weight-bold mb-1">Turkmen: </h5>
												<div className="progress" style={{
													marginLeft: '25px',
													marginTop : '10px',
													fontWeight: 'bold'
										...
										<Col md={5}>
											<div>
												<h5 style={{
													...
													marginTop : '10px',
													fontWeight: 'bold'
												}} className="font-weight-bold mb-1">English: </h5>
												<div className="progress" style={{
													marginLeft: '25px',
													marginTop : '10px',
													fontWeight: 'bold'
											...
											<div>
												<h5 style={{
													...
													marginTop : '10px',
													fontWeight: 'bold'
												}} className="font-weight-bold mb-1">Romanian: </h5>
												<div className="progress" style={{
													marginLeft: '25px',
													marginTop : '10px',
													fontWeight: 'bold'
						...
						<div>
							...
							<img style={{
								marginLeft: '15px',
								marginTop : '5px'
							}} align="left" src="https://img.shields.io/badge/php-%23777BB4.svg?style=for-the-badge&logo=php&logoColor=white"/>
							<img style={{
								marginLeft: '15px',
								marginTop : '5px'
							}} align="left" src="https://img.shields.io/badge/javascript-%23323330.svg?style=for-the-badge&logo=javascript&logoColor=%23F7DF1E"/>
							<img style={{
								marginLeft: '15px',
								marginTop : '5px'
							}} align="left" src="https://img.shields.io/badge/python-3670A0?style=for-the-badge&logo=python&logoColor=ffdd54"/>
							<img style={{
								marginLeft: '15px',
								marginTop : '5px'
							}} align="left" src="https://img.shields.io/badge/react-%2320232a.svg?style=for-the-badge&logo=react&logoColor=%2361DAFB"/>
							<img style={{
								marginLeft: '15px',
								marginTop : '5px'
							}} align="left" src="https://img.shields.io/badge/Next-black?style=for-the-badge&logo=next.js&logoColor=white"/>
							<img style={{
								marginLeft: '15px',
								marginTop : '5px'
							}} align="left" src="https://img.shields.io/badge/AWS-%23FF9900.svg?style=for-the-badge&logo=amazon-aws&logoColor=white"/>
